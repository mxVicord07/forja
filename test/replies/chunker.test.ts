...
describe("chunkReply", () => {
  ...
  it("aplana el Markdown para los canales que no lo renderizan", () => {
  ...
  // chunkReply NO sanea: Telegram y WhatsApp sí renderizan negrita (con su
  // propio dialecto) y cada adapter decide. Ver el comentario de stripMarkdown.
  it("chunkReply deja el Markdown intacto (lo resuelve cada canal)", () => {
