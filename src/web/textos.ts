 ...
 *
 * Porteado del paquete Forja+ v1.0.76 (Modo Agencia, skill /demo) — solo la
 * parte de textos/i18n. El widget embebible completo (web/rutas.ts,
 * web/script.ts, web/widget.ts) queda fuera a propósito: no hay decisión
 * tomada de exponerlo en un sitio real todavía (ver
 * FORJA/_context/specs/2026-09-19-forja-plus-pending-modules.md, Prioridad 3).
 */
