 ...
 *
 * Módulo compartido por DOS entradas: el panel y Forja Inbox
 ...
 *
 * Adaptado del paquete Forja+ v1.0.76: la firma original pasa un tercer
 * argumento `channel` a resolveAgentConfig para "prompt por canal"
 * (personalidad distinta por canal) — este fork no tiene esa función, así
 * que la sugerencia usa el ÚNICO system prompt del bot, igual para
 * cualquier canal (comportamiento correcto para lo que este fork sí tiene).
 */
